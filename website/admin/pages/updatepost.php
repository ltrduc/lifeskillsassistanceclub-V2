...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $checkPost = $managePost->updatePost($id, $author, $title, $postgenre, $posttype, $contentpost);
}
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        ...
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="#!">Chỉnh sửa bài đăng</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card">
                                    ...
                                    <?php
                                    $getPostId = $managePost->getPostId($id);
                                    if ($getPostId != false) {
                                        $value = $getPostId->fetch_assoc();
                                    }
                                    ?>
                                    <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" disabled class="form-control" name="author" value="<?php echo $value['author'] ?>">
                                                        <input type="hidden" class="form-control" name="author" value="<?php echo $value['author'] ?>">
                                                    </div>
                                                </div>
                                                <!-- [End Nguoi dang] -->
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="postgenre" class="custom-select">
                                                            <option selected value="<?php echo $value['postgenre'] ?>">---Thể Loại đã chọn <?php echo $value['postgenre'] ?>---</option>
                                                            <?php
                                                            $getPostgenres = $managePost->getPostgenres();
                                                            if ($getPostgenres && $getPostgenres->num_rows > 0) {
                                                                while ($value_pGenres = $getPostgenres->fetch_assoc()) {
                                                            ?>
                                                                    <option value="<?php echo $value_pGenres['postgenre']; ?>"> <?php echo $value_pGenres['postgenre']; ?></option>
                                                            <?php }
                                                            } ?>
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="posttype" class="custom-select">
                                                            <option selected value="<?php echo $value['posttype'] ?>">---Loại tin tức đã chọn <?php echo $value['posttype'] ?>---</option>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="showImage">
                                                            <img src="<?php echo $value['images'] ?>" class="img-fluid" alt="">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="contentpost" id="contentpost">
