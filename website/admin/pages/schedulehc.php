...
if (isset($delSchedule)) {
    echo $delSchedule;
    echo "<script> setTimeout(() => { window.location = '?q=schedulehc'; }, 1000); </script>";
}
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        ...
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="">Lịch Trực Ban Hành Chính</a></li>
                                        </ul>
                                    </div>
                                    <div class="col-md-4">
                                        <!-- DANG KY CA TRUC -->
                                            ...
                                            <div class="col">
                                                <?php if (Session::get('level') == "050301" || Session::get('level') == "0") { ?>
                                                    <div class="float-right">
                                                        <form action="?q=schedulehc" method="POST">
                                                ...
                                                <div class="float-right">
                                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalhc"><i class="fa fa-edit"></i>&nbsp; Đăng ký</button>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header pb-1">
                                        <h3>LỊCH TRỰC BAN HÀNH CHÍNH</h3>
                                                                        ...
                                                                        ?>
                                                                                <tr>
                                                                                    ...
                                                                                    <?php if (Session::get('level') == "050301" || Session::get('level') == "0" || Session::get('idstudent') == $value['idstudent']) { ?>
                                                                                        <td><a class="text-center btn btn-danger" style="margin: 0; padding: 2px 10px;" onclick="return confirm('Hãy cân nhắc kỹ trước khi xóa?');" href="?q=schedulehc&id=<?php echo $value['id']; ?>" type="submit"><i class="fa fa-trash " style="margin-right: 0;"></i></a></td>
                                                                                    <?php } else { ?>
                                                                                        <td></td>
                                                                                    <?php } ?>
                                                                                </tr>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php if (Session::get('level') == "050301" || Session::get('level') == "0") { ?>
                                                <select name="idstudent" class="form-control form-control-sm">
                                                    ...
                                                    <?php
                                                    $getScheduleHc = $manageSchedule->getScheduleHc();
                                                    if ($getScheduleHc && $getScheduleHc->num_rows > 0) {
                                                        while ($value = $getScheduleHc->fetch_assoc()) {
                                                    ?>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <select name="session" class="form-control form-control-sm">
                                                <option selected value="">---Chọn Buổi Trực---</option>
